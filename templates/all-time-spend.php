...
<div class="wrap">
    <h1><?php echo esc_html__('All-Time Customer Spending', 'membership-discount-manager'); ?></h1>

    <form method="get">
        <input type="hidden" name="page" value="nestwork-discounts">
        <p class="search-box">
            ...
            <?php if (!empty($results)) : ?>
                <?php foreach ($results as $row) : ?>
                    <tr>
                        ...
                        <td><?php echo wc_price($row->total_sales); ?></td>
                        <td><?php echo wc_price($row->total_tax); ?></td>
                        <td><?php echo wc_price($row->total_net); ?></td>
                    </tr>
                <?php endforeach; ?>
            <?php else : ?>
                <tr>
